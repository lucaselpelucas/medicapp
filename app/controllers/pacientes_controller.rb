class PacientesController < ApplicationController
  ...
  private
    ...
    def paciente_params
      params.require(:paciente).permit(:centros_id_id, :poliza, :folio, :nombre, :sexo, :fecha_nacimiento, :curp, :parentesco, :regimen, :domicilio, :colonia, :cp, :ciudad, :estado, :validez_inicio, :validez_termino, :reafiliacion)
    end
end
